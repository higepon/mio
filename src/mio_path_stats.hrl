...
-ifdef(PATH_STATS).
  ...
  -define(MIO_PATH_STATS_PUSH2(A, B), mio_path_stats:push(A, B)).
  -define(MIO_PATH_STATS_PUSH3(A, B, C), mio_path_stats:push(A, B, C)).
...
-else.
  ...
  -define(MIO_PATH_STATS_PUSH2(A, B), ok).
  -define(MIO_PATH_STATS_PUSH3(A, B, C), ok).
