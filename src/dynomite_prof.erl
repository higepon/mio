...
%% API
-export([start_link/0, start_prof/1, stop_prof/1, stats/1, stats/0, averages/0, balance_prof/0]).
...
stats() ->
  gen_server:call(dynomite_prof, stats).
...
handle_call(stats, _From, State = #state{ets=Ets}) ->
