...
c_o_same_mv() ->
    ...
    %% search
    ?assertEqual({error, not_found}, search_op(Bucket, "key0")),
    ?assertEqual({ok, value1}, search_op(Bucket, "key1")),
    ?assertEqual({ok, value2}, search_op(Bucket, "key2")),
    ?assertEqual({ok, value3}, search_op(Bucket, "key3")),
    ?assertEqual({error, not_found}, search_op(RightBucket, "key0")),
    ?assertEqual({ok, value1}, search_op(RightBucket, "key1")),
    ?assertEqual({ok, value2}, search_op(RightBucket, "key2")),
    ?assertEqual({ok, value3}, search_op(RightBucket, "key3")),
...
search_c_o_1(MakeC_O_C_Fun) ->
    ...
    %% search
    ?assertEqual({ok, value0}, search_op(Bucket, "key0")),
    ?assertEqual({ok, value1}, search_op(Bucket, "key1")),
    ?assertEqual({ok, value2}, search_op(Bucket, "key2")),
    ?assertMatch({{?MIN_KEY, false}, {"key2", true}}, mio_bucket:get_range_op(Bucket)),
    ?assertEqual({ok, value3}, search_op(Bucket, "key3")),
    ?assertEqual({ok, value0}, search_op(RightBucket, "key0")),
    ?assertEqual({ok, value1}, search_op(RightBucket, "key1")),
    ?assertEqual({ok, value2}, search_op(RightBucket, "key2")),
    ?assertEqual({ok, value3}, search_op(RightBucket, "key3")).
...
search_c_o_2(MakeC_O_C_Fun) ->
    ...
    %% search
    ?assertEqual({ok, value00}, search_op(Bucket, "key00")),
    ?assertEqual({ok, value01}, search_op(Bucket, "key01")),
    ?assertEqual({ok, value1}, search_op(Bucket, "key1")),
    ?assertEqual({ok, value2}, search_op(Bucket, "key2")),
    ?assertMatch({{?MIN_KEY, false}, {"key1", true}}, mio_bucket:get_range_op(Bucket)),
    ?assertEqual({ok, value3}, search_op(Bucket, "key3")),
    ?assertEqual({ok, value00}, search_op(RightBucket, "key00")),
    ?assertEqual({ok, value01}, search_op(RightBucket, "key01")),
    ?assertEqual({ok, value1}, search_op(RightBucket, "key1")),
    ?assertEqual({ok, value2}, search_op(RightBucket, "key2")),
    ?assertEqual({ok, value3}, search_op(RightBucket, "key3")).
...
search_c_o_3(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value00}, search_op(Bucket, "key00")),
    ?assertEqual({ok, value01}, search_op(Bucket, "key01")),
    ?assertEqual({ok, value02}, search_op(Bucket, "key02")),
    ?assertEqual({ok, value1}, search_op(Bucket, "key1")),
    ?assertEqual({ok, value2}, search_op(Bucket, "key2")),
    ...
    ?assertEqual({ok, value00}, search_op(RightBucket, "key00")),
    ?assertEqual({ok, value01}, search_op(RightBucket, "key01")),
    ?assertEqual({ok, value02}, search_op(RightBucket, "key02")),
    ?assertEqual({ok, value1}, search_op(RightBucket, "key1")),
    ?assertEqual({ok, value2}, search_op(RightBucket, "key2")),
    ?assertEqual({ok, value3}, search_op(RightBucket, "key3")),
    ?assertEqual({ok, value00}, search_op(Middle, "key00")),
    ?assertEqual({ok, value01}, search_op(Middle, "key01")),
    ?assertEqual({ok, value02}, search_op(Middle, "key02")),
    ?assertEqual({ok, value1}, search_op(Middle, "key1")),
    ?assertEqual({ok, value2}, search_op(Middle, "key2")),
    ?assertEqual({ok, value3}, search_op(Middle, "key3")).
...
search_c_o_4(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value2}, search_op(Bucket, "key2")),
    ?assertEqual({ok, value3}, search_op(Bucket, "key3")),
    ?assertEqual({ok, value4}, search_op(Bucket, "key4")),
    ?assertEqual({ok, value5}, search_op(Bucket, "key5")),
    ?assertEqual({ok, value6}, search_op(Bucket, "key6")),

    ?assertEqual({ok, value1}, search_op(Middle, "key1")),
    ?assertEqual({ok, value2}, search_op(Middle, "key2")),
    ?assertEqual({ok, value3}, search_op(Middle, "key3")),
    ?assertEqual({ok, value4}, search_op(Middle, "key4")),
    ?assertEqual({ok, value5}, search_op(Middle, "key5")),
    ?assertEqual({ok, value6}, search_op(Middle, "key6")),

    ?assertMatch({{?MIN_KEY, false}, {"key3", true}}, mio_bucket:get_range_op(Bucket)),
    ?assertEqual({ok, value1}, search_op(RightBucket, "key1")),
    ?assertEqual({ok, value2}, search_op(RightBucket, "key2")),
    ?assertEqual({ok, value3}, search_op(RightBucket, "key3")),
    ?assertEqual({ok, value4}, search_op(RightBucket, "key4")),
    ?assertEqual({ok, value5}, search_op(RightBucket, "key5")),
    ?assertEqual({ok, value6}, search_op(RightBucket, "key6")),
...
search_c_o_c_1(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value0}, search_op(Left, "key0")),
    ?assertEqual({ok, value1}, search_op(Left, "key1")),
    ?assertEqual({ok, value2}, search_op(Left, "key2")),
    ?assertEqual({ok, value3}, search_op(Left, "key3")),
    ?assertEqual({ok, value4}, search_op(Left, "key4")),
    ?assertEqual({ok, value5}, search_op(Left, "key5")),
    ?assertEqual({ok, value6}, search_op(Left, "key6")),

    ?assertEqual({ok, value0}, search_op(Middle, "key0")),
    ?assertEqual({ok, value1}, search_op(Middle, "key1")),
    ?assertEqual({ok, value2}, search_op(Middle, "key2")),
    ?assertEqual({ok, value3}, search_op(Middle, "key3")),
    ?assertEqual({ok, value4}, search_op(Middle, "key4")),
    ...
    ?assertEqual({ok, value0}, search_op(Right, "key0")),
    ?assertEqual({ok, value1}, search_op(Right, "key1")),
    ?assertEqual({ok, value2}, search_op(Right, "key2")),
    ?assertEqual({ok, value3}, search_op(Right, "key3")),
    ?assertEqual({ok, value4}, search_op(Right, "key4")),
    ?assertEqual({ok, value5}, search_op(Right, "key5")),
    ?assertEqual({ok, value6}, search_op(Right, "key6")).
...
search_c_o_c_2(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value1}, search_op(NewBucket, "key1")),
    ?assertEqual({ok, value2}, search_op(NewBucket, "key2")),
    ?assertEqual({ok, value3}, search_op(NewBucket, "key3")),
    ?assertEqual({ok, value4}, search_op(NewBucket, "key4")),
    ?assertEqual({ok, value5}, search_op(NewBucket, "key5")),
    ?assertEqual({ok, value6}, search_op(NewBucket, "key6")),
    ?assertEqual({ok, value7}, search_op(NewBucket, "key7")),
    ...
    ?assertEqual({ok, value5}, search_op(Left, "key5")),
    ?assertEqual({ok, value6}, search_op(Left, "key6")),
    ?assertEqual({ok, value7}, search_op(Left, "key7")),
    ...
    ?assertEqual({ok, value5}, search_op(Middle, "key5")),
    ?assertEqual({ok, value6}, search_op(Middle, "key6")),
    ?assertEqual({ok, value7}, search_op(Middle, "key7")),
    ...
    ?assertEqual({ok, value5}, search_op(Right, "key5")),
    ?assertEqual({ok, value6}, search_op(Right, "key6")),
    ?assertEqual({ok, value7}, search_op(Right, "key7")).
...
search_c_o_c_3(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value5}, search_op(Left, "key5")),
    ?assertEqual({ok, value6}, search_op(Left, "key6")),
    ?assertEqual({ok, value30}, search_op(Left, "key30")),
    ...
    ?assertEqual({ok, value5}, search_op(Middle, "key5")),
    ?assertEqual({ok, value6}, search_op(Middle, "key6")),
    ?assertEqual({ok, value30}, search_op(Middle, "key30")),
    ...
    ?assertEqual({ok, value5}, search_op(Right, "key5")),
    ?assertEqual({ok, value6}, search_op(Right, "key6")),
    ?assertEqual({ok, value30}, search_op(Right, "key30")).
...
search_c_o_c_4(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value5}, search_op(NewBucket, "key5")),
    ?assertEqual({ok, value6}, search_op(NewBucket, "key6")),
    ?assertEqual({ok, value30}, search_op(NewBucket, "key30")),
    ?assertEqual({ok, value31}, search_op(NewBucket, "key31")),
    ?assertEqual({ok, value32}, search_op(NewBucket, "key32")),
    ...
    ?assertEqual({ok, value6}, search_op(Left, "key6")),
    ?assertEqual({ok, value30}, search_op(Left, "key30")),
    ?assertEqual({ok, value31}, search_op(Left, "key31")),
    ?assertEqual({ok, value32}, search_op(Left, "key32")),
    ...
    ?assertEqual({ok, value6}, search_op(Middle, "key6")),
    ?assertEqual({ok, value30}, search_op(Middle, "key30")),
    ?assertEqual({ok, value31}, search_op(Middle, "key31")),
    ?assertEqual({ok, value32}, search_op(Middle, "key32")),
    ...
    ?assertEqual({ok, value6}, search_op(Right, "key6")),
    ?assertEqual({ok, value30}, search_op(Right, "key30")),
    ?assertEqual({ok, value31}, search_op(Right, "key31")),
    ?assertEqual({ok, value32}, search_op(Right, "key32")).
...
search_c_o_c_5(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value30}, search_op(NewBucket, "key30")),
    ?assertEqual({ok, value31}, search_op(NewBucket, "key31")),
    ?assertEqual({ok, value22}, search_op(NewBucket, "key22")),
    ...
    ?assertEqual({ok, value30}, search_op(Left, "key30")),
    ?assertEqual({ok, value31}, search_op(Left, "key31")),
    ?assertEqual({ok, value22}, search_op(Left, "key22")),
    ...
    ?assertEqual({ok, value30}, search_op(Middle, "key30")),
    ?assertEqual({ok, value31}, search_op(Middle, "key31")),
    ?assertEqual({ok, value22}, search_op(Middle, "key22")),
    ...
    ?assertEqual({ok, value30}, search_op(Right, "key30")),
    ?assertEqual({ok, value31}, search_op(Right, "key31")),
    ?assertEqual({ok, value22}, search_op(Right, "key22")).
...
search_c_o_c_6(MakeC_O_C_Fun) ->
    ...
    ?assertEqual({ok, value30}, search_op(NewBucket, "key30")),
    ?assertEqual({ok, value31}, search_op(NewBucket, "key31")),
    ?assertEqual({ok, value55}, search_op(NewBucket, "key55")),
    ...
    ?assertEqual({ok, value30}, search_op(Left, "key30")),
    ?assertEqual({ok, value31}, search_op(Left, "key31")),
    ?assertEqual({ok, value55}, search_op(Left, "key55")),
    ...
    ?assertEqual({ok, value30}, search_op(Middle, "key30")),
    ?assertEqual({ok, value31}, search_op(Middle, "key31")),
    ?assertEqual({ok, value55}, search_op(Middle, "key55")),
    ...
    ?assertEqual({ok, value30}, search_op(Right, "key30")),
    ?assertEqual({ok, value31}, search_op(Right, "key31")),
    ?assertEqual({ok, value55}, search_op(Right, "key55")).
...
do_insert_many() ->
    ...
    ?assertEqual({ok, "d4bd50c13cb2c368"}, search_op(Bucket, "d4bd50c13cb2c368")),
    {ok, _} = mio_skip_graph:insert_op(Bucket, "7b077f782f5239c6", "7b077f782f5239c6"),
    ?assertEqual({ok, "7b077f782f5239c6"}, search_op(Bucket, "7b077f782f5239c6")),
    ?assertEqual({ok, "d4bd50c13cb2c368"}, search_op(Bucket, "d4bd50c13cb2c368")),
    {ok, _} = mio_skip_graph:insert_op(Bucket, "dc3df49638adfd2b", "dc3df49638adfd2b"),
    ?assertEqual({ok, "dc3df49638adfd2b"}, search_op(Bucket, "dc3df49638adfd2b")),
    ?assertEqual({ok, "7b077f782f5239c6"}, search_op(Bucket, "7b077f782f5239c6")),
    ?assertEqual({ok, "d4bd50c13cb2c368"}, search_op(Bucket, "d4bd50c13cb2c368")),
    {ok, _} = mio_skip_graph:insert_op(Bucket, "3a18f2c88d4ef922", "3a18f2c88d4ef922"),
    ?assertEqual({ok, "3a18f2c88d4ef922"}, search_op(Bucket, "3a18f2c88d4ef922")),
    ?assertEqual({ok, "dc3df49638adfd2b"}, search_op(Bucket, "dc3df49638adfd2b")),
    ?assertEqual({ok, "7b077f782f5239c6"}, search_op(Bucket, "7b077f782f5239c6")),
    ?assertEqual({ok, "d4bd50c13cb2c368"}, search_op(Bucket, "d4bd50c13cb2c368")),
    {ok, _} = mio_skip_graph:insert_op(Bucket, "0177ebdfb54aba4c", "0177ebdfb54aba4c"),
    ?assertEqual({ok, "0177ebdfb54aba4c"}, search_op(Bucket, "0177ebdfb54aba4c")),
    ?assertEqual({ok, "3a18f2c88d4ef922"}, search_op(Bucket, "3a18f2c88d4ef922")),
    ?assertEqual({ok, "dc3df49638adfd2b"}, search_op(Bucket, "dc3df49638adfd2b")),
    ?assertEqual({ok, "7b077f782f5239c6"}, search_op(Bucket, "7b077f782f5239c6")),
    ?assertEqual({ok, "d4bd50c13cb2c368"}, search_op(Bucket, "d4bd50c13cb2c368")),
    {ok, _} = mio_skip_graph:insert_op(Bucket, "fc88c7d803f02fce", "fc88c7d803f02fce"),
    ?assertEqual({ok, "fc88c7d803f02fce"}, search_op(Bucket, "fc88c7d803f02fce")),
    ?assertEqual({ok, "0177ebdfb54aba4c"}, search_op(Bucket, "0177ebdfb54aba4c")),
    ?assertEqual({ok, "3a18f2c88d4ef922"}, search_op(Bucket, "3a18f2c88d4ef922")),
    ?assertEqual({ok, "dc3df49638adfd2b"}, search_op(Bucket, "dc3df49638adfd2b")),
    ?assertEqual({ok, "7b077f782f5239c6"}, search_op(Bucket, "7b077f782f5239c6")),
    ...
    ?assertEqual({ok, "ae0aaa8b1c701ea7"}, search_op(Bucket, "ae0aaa8b1c701ea7")),
    ?assertEqual({ok, "fc88c7d803f02fce"}, search_op(Bucket, "fc88c7d803f02fce")),
    ?assertEqual({ok, "0177ebdfb54aba4c"}, search_op(Bucket, "0177ebdfb54aba4c")),
    ?assertEqual({ok, "3a18f2c88d4ef922"}, search_op(Bucket, "3a18f2c88d4ef922")),
    ?assertEqual({ok, "dc3df49638adfd2b"}, search_op(Bucket, "dc3df49638adfd2b")),
    ...
    ?assertEqual({ok, "5580da7ca4202565"}, search_op(Bucket, "5580da7ca4202565")),
    ?assertEqual({ok, "ae0aaa8b1c701ea7"}, search_op(Bucket, "ae0aaa8b1c701ea7")),
    ?assertEqual({ok, "fc88c7d803f02fce"}, search_op(Bucket, "fc88c7d803f02fce")),
    ?assertEqual({ok, "0177ebdfb54aba4c"}, search_op(Bucket, "0177ebdfb54aba4c")),
    ?assertEqual({ok, "3a18f2c88d4ef922"}, search_op(Bucket, "3a18f2c88d4ef922")),
    ...
    ?assertEqual({ok, "d2043d9b37d14ebf"}, search_op(Bucket, "d2043d9b37d14ebf")),
    ?assertEqual({ok, "5580da7ca4202565"}, search_op(Bucket, "5580da7ca4202565")),
    ?assertEqual({ok, "ae0aaa8b1c701ea7"}, search_op(Bucket, "ae0aaa8b1c701ea7")),
    ?assertEqual({ok, "fc88c7d803f02fce"}, search_op(Bucket, "fc88c7d803f02fce")),
    ?assertEqual({ok, "0177ebdfb54aba4c"}, search_op(Bucket, "0177ebdfb54aba4c")),
    ...
    ?assertEqual({ok, "aeaf94f572e71d9c"}, search_op(Bucket, "aeaf94f572e71d9c")),
    ?assertEqual({ok, "d2043d9b37d14ebf"}, search_op(Bucket, "d2043d9b37d14ebf")),
    ?assertEqual({ok, "5580da7ca4202565"}, search_op(Bucket, "5580da7ca4202565")),
    ?assertEqual({ok, "ae0aaa8b1c701ea7"}, search_op(Bucket, "ae0aaa8b1c701ea7")),
    ?assertEqual({ok, "fc88c7d803f02fce"}, search_op(Bucket, "fc88c7d803f02fce")),
...
%%    mio_skip_graph:dump_op(Bucket),
    ?assertEqual({ok, "5e4f257214882b66"}, search_op(Bucket, "5e4f257214882b66")),
    ?assertEqual({ok, "aeaf94f572e71d9c"}, search_op(Bucket, "aeaf94f572e71d9c")),
    ?assertEqual({ok, "d2043d9b37d14ebf"}, search_op(Bucket, "d2043d9b37d14ebf")),
    ?assertEqual({ok, "5580da7ca4202565"}, search_op(Bucket, "5580da7ca4202565")),
    ?assertEqual({ok, "ae0aaa8b1c701ea7"}, search_op(Bucket, "ae0aaa8b1c701ea7")),
    ...
    ?assertEqual({ok, "f8d5e4182acde4df"}, search_op(Bucket, "f8d5e4182acde4df")),
    ?assertEqual({ok, "5e4f257214882b66"}, search_op(Bucket, "5e4f257214882b66")),
    ?assertEqual({ok, "aeaf94f572e71d9c"}, search_op(Bucket, "aeaf94f572e71d9c")),
    ?assertEqual({ok, "d2043d9b37d14ebf"}, search_op(Bucket, "d2043d9b37d14ebf")),
    ?assertEqual({ok, "5580da7ca4202565"}, search_op(Bucket, "5580da7ca4202565")),
...
%%    mio_skip_graph:dump_op(Bucket),
    ?assertEqual({ok, "f3a18fe8b425450e"}, search_op(Bucket, "f3a18fe8b425450e")),
    ?assertEqual({ok, "f8d5e4182acde4df"}, search_op(Bucket, "f8d5e4182acde4df")),
    ?assertEqual({ok, "5e4f257214882b66"}, search_op(Bucket, "5e4f257214882b66")),
    ?assertEqual({ok, "aeaf94f572e71d9c"}, search_op(Bucket, "aeaf94f572e71d9c")),
    ?assertEqual({ok, "d2043d9b37d14ebf"}, search_op(Bucket, "d2043d9b37d14ebf")),
    ...
    ?assertEqual({ok, "4a0672495168237d"}, search_op(Bucket, "4a0672495168237d")),
    ?assertEqual({ok, "f3a18fe8b425450e"}, search_op(Bucket, "f3a18fe8b425450e")),
    ?assertEqual({ok, "f8d5e4182acde4df"}, search_op(Bucket, "f8d5e4182acde4df")),
    ?assertEqual({ok, "5e4f257214882b66"}, search_op(Bucket, "5e4f257214882b66")),
    ?assertEqual({ok, "aeaf94f572e71d9c"}, search_op(Bucket, "aeaf94f572e71d9c")),
    ...
    ?assertEqual({ok, "1923dbe8af615049"}, search_op(Bucket, "1923dbe8af615049")),
    ?assertEqual({ok, "4a0672495168237d"}, search_op(Bucket, "4a0672495168237d")),
    ?assertEqual({ok, "f3a18fe8b425450e"}, search_op(Bucket, "f3a18fe8b425450e")),
    ?assertEqual({ok, "f8d5e4182acde4df"}, search_op(Bucket, "f8d5e4182acde4df")),
    ?assertEqual({ok, "5e4f257214882b66"}, search_op(Bucket, "5e4f257214882b66")),
    ...
    ?assertEqual({ok, "c12368669cccc56e"}, search_op(Bucket, "c12368669cccc56e")),
    ?assertEqual({ok, "1923dbe8af615049"}, search_op(Bucket, "1923dbe8af615049")),
    ?assertEqual({ok, "4a0672495168237d"}, search_op(Bucket, "4a0672495168237d")),
    ?assertEqual({ok, "f3a18fe8b425450e"}, search_op(Bucket, "f3a18fe8b425450e")),
    ?assertEqual({ok, "f8d5e4182acde4df"}, search_op(Bucket, "f8d5e4182acde4df")),
    ...
    ?assertEqual({ok, "97d283ca38bd0e1c"}, search_op(Bucket, "97d283ca38bd0e1c")),
    ?assertEqual({ok, "c12368669cccc56e"}, search_op(Bucket, "c12368669cccc56e")),
    ?assertEqual({ok, "1923dbe8af615049"}, search_op(Bucket, "1923dbe8af615049")),
    ?assertEqual({ok, "4a0672495168237d"}, search_op(Bucket, "4a0672495168237d")),
    ?assertEqual({ok, "f3a18fe8b425450e"}, search_op(Bucket, "f3a18fe8b425450e")),
    ...
    ?assertEqual({ok, "f2369ca008446bda"}, search_op(Bucket, "f2369ca008446bda")),
    ?assertEqual({ok, "97d283ca38bd0e1c"}, search_op(Bucket, "97d283ca38bd0e1c")),
    ?assertEqual({ok, "c12368669cccc56e"}, search_op(Bucket, "c12368669cccc56e")),
    ?assertEqual({ok, "1923dbe8af615049"}, search_op(Bucket, "1923dbe8af615049")),
    ?assertEqual({ok, "4a0672495168237d"}, search_op(Bucket, "4a0672495168237d")),
...
%%    mio_skip_graph:dump_op(Bucket),
    ?assertEqual({ok, "325af468d6b6b460"}, search_op(Bucket, "325af468d6b6b460")),
    ?assertEqual({ok, "f2369ca008446bda"}, search_op(Bucket, "f2369ca008446bda")),
    ?assertEqual({ok, "97d283ca38bd0e1c"}, search_op(Bucket, "97d283ca38bd0e1c")),
    ?assertEqual({ok, "c12368669cccc56e"}, search_op(Bucket, "c12368669cccc56e")),
    ?assertEqual({ok, "1923dbe8af615049"}, search_op(Bucket, "1923dbe8af615049")),
    ...
    ?assertEqual({ok, "1506b21ba57e6241"}, search_op(Bucket, "1506b21ba57e6241")),
    ?assertEqual({ok, "325af468d6b6b460"}, search_op(Bucket, "325af468d6b6b460")),
    ?assertEqual({ok, "f2369ca008446bda"}, search_op(Bucket, "f2369ca008446bda")),
    ?assertEqual({ok, "97d283ca38bd0e1c"}, search_op(Bucket, "97d283ca38bd0e1c")),
    ?assertEqual({ok, "c12368669cccc56e"}, search_op(Bucket, "c12368669cccc56e")),
    ...
    ?assertEqual({ok, "694ff99f8b29aab0"}, search_op(Bucket, "694ff99f8b29aab0")),
    ?assertEqual({ok, "1506b21ba57e6241"}, search_op(Bucket, "1506b21ba57e6241")),
    ?assertEqual({ok, "325af468d6b6b460"}, search_op(Bucket, "325af468d6b6b460")),
    ?assertEqual({ok, "f2369ca008446bda"}, search_op(Bucket, "f2369ca008446bda")),
    ?assertEqual({ok, "97d283ca38bd0e1c"}, search_op(Bucket, "97d283ca38bd0e1c")),
...
%%    mio_skip_graph:dump_op(Bucket),
    ?assertEqual({ok, "f270646a9b74dde0"}, search_op(Bucket, "f270646a9b74dde0")),
    ?assertEqual({ok, "694ff99f8b29aab0"}, search_op(Bucket, "694ff99f8b29aab0")),
    ?assertEqual({ok, "1506b21ba57e6241"}, search_op(Bucket, "1506b21ba57e6241")),
    ?assertEqual({ok, "325af468d6b6b460"}, search_op(Bucket, "325af468d6b6b460")),
    ?assertEqual({ok, "f2369ca008446bda"}, search_op(Bucket, "f2369ca008446bda")),
    ...
    ?assertEqual({ok, "3929e7412fa542aa"}, search_op(Bucket, "3929e7412fa542aa")),
    ?assertEqual({ok, "f270646a9b74dde0"}, search_op(Bucket, "f270646a9b74dde0")),
    ?assertEqual({ok, "694ff99f8b29aab0"}, search_op(Bucket, "694ff99f8b29aab0")),
    ?assertEqual({ok, "1506b21ba57e6241"}, search_op(Bucket, "1506b21ba57e6241")),
    ?assertEqual({ok, "325af468d6b6b460"}, search_op(Bucket, "325af468d6b6b460")),
...
%%    mio_skip_graph:dump_op(Bucket),
    ?assertEqual({ok, "5022491d338a4ac2"}, search_op(Bucket, "5022491d338a4ac2")),
    ?assertEqual({ok, "3929e7412fa542aa"}, search_op(Bucket, "3929e7412fa542aa")),
    ?assertEqual({ok, "f270646a9b74dde0"}, search_op(Bucket, "f270646a9b74dde0")),
    ?assertEqual({ok, "694ff99f8b29aab0"}, search_op(Bucket, "694ff99f8b29aab0")),
    ?assertEqual({ok, "1506b21ba57e6241"}, search_op(Bucket, "1506b21ba57e6241")),
...
%%    mio_skip_graph:dump_op(Bucket),
    ?assertEqual({ok, "87c3061cf0ed9dae"}, search_op(Bucket, "87c3061cf0ed9dae")),
    ?assertEqual({ok, "5022491d338a4ac2"}, search_op(Bucket, "5022491d338a4ac2")),
    ?assertEqual({ok, "3929e7412fa542aa"}, search_op(Bucket, "3929e7412fa542aa")),
    ?assertEqual({ok, "f270646a9b74dde0"}, search_op(Bucket, "f270646a9b74dde0")),
    ?assertEqual({ok, "694ff99f8b29aab0"}, search_op(Bucket, "694ff99f8b29aab0")),
    ...
    ?assertEqual({ok, "72725872d73c8881"}, search_op(Bucket, "72725872d73c8881")),
    ?assertEqual({ok, "87c3061cf0ed9dae"}, search_op(Bucket, "87c3061cf0ed9dae")),
    ?assertEqual({ok, "5022491d338a4ac2"}, search_op(Bucket, "5022491d338a4ac2")),
    ?assertEqual({ok, "3929e7412fa542aa"}, search_op(Bucket, "3929e7412fa542aa")),
    ?assertEqual({ok, "f270646a9b74dde0"}, search_op(Bucket, "f270646a9b74dde0")),
    ...
    ?assertEqual({ok, "378e1ad721639aa5"}, search_op(Bucket, "378e1ad721639aa5")),
    ?assertEqual({ok, "72725872d73c8881"}, search_op(Bucket, "72725872d73c8881")),
    ?assertEqual({ok, "87c3061cf0ed9dae"}, search_op(Bucket, "87c3061cf0ed9dae")),
    ?assertEqual({ok, "5022491d338a4ac2"}, search_op(Bucket, "5022491d338a4ac2")),
    ?assertEqual({ok, "3929e7412fa542aa"}, search_op(Bucket, "3929e7412fa542aa")),
    ...
    ?assertEqual({ok, "e56afcd4a7841e2c"}, search_op(Bucket, "e56afcd4a7841e2c")),
    ?assertEqual({ok, "378e1ad721639aa5"}, search_op(Bucket, "378e1ad721639aa5")),
    ?assertEqual({ok, "72725872d73c8881"}, search_op(Bucket, "72725872d73c8881")),
    ?assertEqual({ok, "87c3061cf0ed9dae"}, search_op(Bucket, "87c3061cf0ed9dae")),
    ?assertEqual({ok, "5022491d338a4ac2"}, search_op(Bucket, "5022491d338a4ac2")),
    ...
    ?assertEqual({ok, "9ad21cf2116c8f12"}, search_op(Bucket, "9ad21cf2116c8f12")),
    ?assertEqual({ok, "e56afcd4a7841e2c"}, search_op(Bucket, "e56afcd4a7841e2c")),
    ?assertEqual({ok, "378e1ad721639aa5"}, search_op(Bucket, "378e1ad721639aa5")),
    ?assertEqual({ok, "72725872d73c8881"}, search_op(Bucket, "72725872d73c8881")),
    ?assertEqual({ok, "87c3061cf0ed9dae"}, search_op(Bucket, "87c3061cf0ed9dae")),
    ...
    ?assertEqual({ok, "3538dbd9389a630a"}, search_op(Bucket, "3538dbd9389a630a")),
    ?assertEqual({ok, "9ad21cf2116c8f12"}, search_op(Bucket, "9ad21cf2116c8f12")),
    ?assertEqual({ok, "e56afcd4a7841e2c"}, search_op(Bucket, "e56afcd4a7841e2c")),
    ?assertEqual({ok, "378e1ad721639aa5"}, search_op(Bucket, "378e1ad721639aa5")),
    ?assertEqual({ok, "72725872d73c8881"}, search_op(Bucket, "72725872d73c8881")),
...
search_op(Bucket, Key) ->
    case mio_skip_graph:search_op(Bucket, Key) of
        {ok, Value, _ExpirationTime} ->
            {ok, Value};
        Other ->
            Other
